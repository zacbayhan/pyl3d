...
def get_temp():
    return bus.read_byte_data(DEVICE_ADDRESS, REG_STATUS_REG)
...
def readRaw():
    temp = bus.write_byte_data(DEVICE_ADDRESS, 7, REG_OUT_X_L)
    print 'temp: ', bus.read_byte_data(DEVICE_ADDRESS, 6)
